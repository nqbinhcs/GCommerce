...
import com.example.e_commerce.Adaptor.FoodAdaptor;
...
//        });
    ...
    private void recyclerViewFoodCat() {
        ...
        foodList = new ArrayList<FoodDomain>();
        // -------------------------Query from database-----------------------
        foodList.add(new FoodDomain("001", "Bell Peper Red", "red_pepper", "Binh", "Vegetable", "Pieces of bell pepper are commonly used in garden salads and as toppings on pizza", 34.0, 5.0, 1));
        adapter = new FoodAdaptor(foodList);
